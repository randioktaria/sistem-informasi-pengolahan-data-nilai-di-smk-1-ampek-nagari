    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                  <form action="{{ Route('mata-pelajaran-kelas.update', $mapelkelas->kode_mapel_kelas) }}" method="post">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="kode_kelas" id="kode_kelas" class="form-control">
                                    <option value="{{ $mapelkelas->kode_kelas }}">{{ $mapelkelas->kelas->kelas }}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="kode_guru" id="kode_guru" class="form-control">
                                    <option value="{{ $mapelkelas->kode_guru }}">{{ $mapelkelas->guru->nama }}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="kode_mapel" id="kode_mapel" class="form-control">
                                    <option value="{{ $mapelkelas->kode_mapel }}">{{ $mapelkelas->mapel->mapel }}</option>
