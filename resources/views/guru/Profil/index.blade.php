                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $profil->kode_guru }}" disabled>
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="form-group">
                        <label>Nama</label>
                        <input type="text" class="form-control"  value="{{ $profil->nama }}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
          ...
          <div class="col-md-4">
            <div class="card card-user">
              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-gray" src="{{ asset(isset($profil->foto) ? 'img/faces/guru/'.$profil->foto : 'img/default-avatar.png') }}" alt="...">
                    <h5 class="title">{{ $profil->nama }}</h5>
                  </a>
                </div>
                <hr>
                <p class="description text-center">
                  {{ isset($profil->kelas->kelas) ? 'Wali kelas : '.$profil->kelas->kelas : '' }}
      ...
      <div class="content">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('profil-guru/create/photo') }}" method="post" enctype="multipart/form-data">
                          @csrf
                          <div class="form-group">
